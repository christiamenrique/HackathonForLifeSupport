    ...
    <>
      <main class="calendar-contain">
        <section class="title-bar">
          ...
          <span class="title-bar__year">Calendar > October 2019</span>
          <span class="title-bar__month">Month</span>
        ...
        <aside class="calendar__sidebar">
          ...
          <ul class="sidebar__list">
            <li class="sidebar__list-item sidebar__list-item--complete">
              <span class="list-item__time">8.30</span> School
            </li>
            <li class="sidebar__list-item sidebar__list-item--complete">
              <span class="list-item__time">10.00</span> Lunch
            </li>
            <li class="sidebar__list-item">
              <span class="list-item__time">2.30</span> Practice
            </li>
            <li class="sidebar__list-item">
              <span class="list-item__time">4.00</span> Game
            </li>
          </ul>
        </aside>
